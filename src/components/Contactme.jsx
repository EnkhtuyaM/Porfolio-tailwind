...
export const Contactme = () => {
  return (
    <div className="w-[1440px] h-[560px] flex flex-col px-20 py-24 gap-4 m-auto">
      <div className="flex justify-center"> 
        <Button buttName={"Get in touch"} />
      </div>
      <div className="w-[1216px] h-[56px] flex pl-64 mb-4">
        <p>
      ...
      <div className="flex gap-8 justify-center">
        ...
        <p className="text-2xl font-bold">reachsagarshah@gmail.com</p>
        <svg
          width="44"
          height="44"
          viewBox="0 0 44 44"
      ...
      <div className="flex gap-8 justify-center mb-12">
        ...
        <p className="text-2xl font-bold">+91 8980500565</p>
        <svg
          width="32"
          height="32"
          viewBox="0 0 32 32"
