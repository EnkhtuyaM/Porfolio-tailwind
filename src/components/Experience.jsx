export const Experience=()=>{
    return(
      <div className="w-[1440px] h-[1140px] flex flex-col bg-gray-50">
        <div className="flex justify-center mt-12">
          <button className="flex w-[105px] h-7 border-2 rounded-lg justify-center">Experience</button>
        </div>
        <div className="flex justify-between ">
          <h3 className="w-[1216px] h-[28px] ps-[530px] mt-6 mb-12">
          Here is a quick summary of my most recent experiences:
          </h3>
        </div>
        <div className="w-[1440px] h-[1140px] bg-gray-50 flex flex-col gap-12"> 
        <div className="w-[1280px] h-[288px] flex gap-[48px] pl-[164px] ml-[32px] bg-white">
