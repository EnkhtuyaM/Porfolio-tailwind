export const Hero=()=>{
    return(
        <div className="flex w-[1440px] h-[552px] px-8 py-16 bg-red-200 gap-28">
            <div className="flex flex-col w-[768px] h-[152px] gap-8">
                ...
                <p className="w-[24px] h-[24px]"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
  ...
  <path d="M12 13C13.6569 13 15 11.6569 15 10C15 8.34315 13.6569 7 12 7C10.3431 7 9 8.34315 9 10C9 11.6569 10.3431 13 12 13Z" stroke="#4B5563" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <p className="w-[8px] h-[8px]"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect x="8" y="8" width="8" height="8" rx="4" fill="#10B981"/>
</svg>
</p>
                <p className="w-[197px] h-[24px]">Available for new projects</p>
