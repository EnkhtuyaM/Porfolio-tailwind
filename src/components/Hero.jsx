export const Hero = () => {
  return (
    <div className="flex w-[1440px] h-[552px] px-20 py-24 gap-48 m-auto">
      <div className="flex flex-col w-[768px] h-[152px] gap-6">
        <h1 className="w-[418px] h-[72px] font-bold text-5xl text-gray-900">
          Hi, I’m Sagar 👋
        </h1>
        <p className="w-[768px h-[72px mb-8 text-base text-gray-600]">
        ...
        <div className="flex gap-3">
          ...
          <p className="w-[137px] h-[24px]">Ahmedabad, India</p>
        </div>
        <div className="flex gap-6">
          <p className="w-[8px] h-[8px]">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
          ...
          <p className="w-[197px] h-[24px] mb-8">Available for new projects</p>
        </div>
        <div className="flex">
          <svg
            width="36"
      ...
      <div className="w-[400px] h-[360px] px-12">
